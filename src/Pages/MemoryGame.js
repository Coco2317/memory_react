...
import deckImage from "../assets/bazinga.jpg"; // ✅ ton visuel Bazinga rouge
import backgroundImage from "../assets/background.jpg"; // ✅ ton fond de page
...
function MemoryGame({ playerName, level }) {
  ...
  // Mélange des cartes selon le niveau
  useEffect(() => {
    let pairCount = 6;
